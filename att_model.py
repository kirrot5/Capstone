...
class AttModel(CaptionModel):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, opt={}, heatmaps=None, heatmap_masks=None):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(
            fc_feats, att_feats, att_masks, heatmaps, heatmap_masks)
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, heatmaps=None, heatmap_masks=None):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(fc_feats, att_feats, att_masks, opt, heatmaps, heatmap_masks)
        if group_size > 1:
